        ...
        <div class="media align-items-center">
            ...
            <a class="flexbox align-items-center flex-grow gap-items text-truncate" href="#qv-user-details"
                ...
                <div class="media-body text-truncate">
                    ...
                    <small>
                        <span>#68435</span>
                        <span class="divider-dash">On 23 March 2017</span>
                        <span class="divider-dash"><span class="text-warning">Manual</span></span>
                    </small>
                </div>
            </a>
        ...
        <div class="media align-items-center">
            ...
            <a class="flexbox align-items-center flex-grow gap-items text-truncate" href="#qv-user-details"
                ...
                <div class="media-body text-truncate">
                    ...
                    <small>
                        <span>#68531</span>
                        <span class="divider-dash">On 03 March 2017</span>
                        <span class="divider-dash"><span class="text-warning">Mpesa</span></span>
                    </small>
                </div>
            </a>
...
<div id="qv-user-details" class="quickview quickview-lg">
    <header class="quickview-header">
        <p class="quickview-title lead fw-400">Update Invoice</p>
        <span class="close"><i class="ti-close"></i></span>
    </header>
