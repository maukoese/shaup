<div class="topbar">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2">
                <div class="logo"><a href="{{ url('/') }}" title=""><img src="{{asset('images/logo.png')}}" alt=""></a></div>
            </div>
            <div class="col-lg-9">
                <ul class="notify-area">
                    ...
                    <li class="notifications"><a href="#" title=""><i class="fa fa-bell-o"></i></a><span
                            class="red-bg">02</span>
                    ...
                    <li class="messages"><a href="#" title=""><i class="fa fa-envelope-o"></i></a><span
                            class="blue-bg">10</span>
                        <div class="drop messages"> <span class="drop-head">3 New Message <i
                            ...
                            <span class="drop-bottom"><a href="#" title="">View More messages</a></span>
                        </div>
                    </li>
                    <li class="mega">
                        <!-- <a href="#" title="">mega</a> -->
                ...
                <div class="t-search">
                    <form action="{{url('search')}}">
                        <input name="s" type="text" placeholder="Enter Your Keyword" value="{{app('request')->query('s')}}">
                ...
                <ul class="seting-area">
                    ...
                    <li class=""><a href="{{url('settings')}}" title=""><i class="icon-settings"></i></a></li>
                </ul>
            </div>
            <div class="col-lg-1">
                <div class="user-head">
                    <div class="admin">
                        <div class="admin-avatar">
                            <img src="{{auth()->user()->avatar}}" alt="{{auth()->user()->name}}" width="40px">
                            <i class="online"></i>
                        </div>
                    </div>
                    <div class="drop setting">
                        ...
                        <span class="drop-bottom"><a href="{{ route('logout') }}" onclick="event.preventDefault();
