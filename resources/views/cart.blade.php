        ...
        <div class="gap">
          <div class="discount-copon">
            ...
            <div class="col-md-4"> <span>discount</span>
              <p>If you have any discount vouchers/coupons, apply here. If you don't have any, click here to get one.</p>
            </div>
            <div class="col-md-8">
              <form method="post">
                <label>Coupon No</label>
                <input type="text" placeholder="Coupon No.">
        ...
        <div class="gap no-gap">
          <div class="cart-summary">
            ...
            <ul class="cart-total">
              ...
              <li>Coupon Discount:<span>-$55</span></li>
