...
return [
    ...
    */
    ...
    'twitter' => [
        ...
        'redirect'      => env('TWITTER_URL', 'https://shaup/login/twitter/callback'),
    ],

    'google' => [
        'client_id'     => env('GOOGLE_CLIENT_ID', ''),
        'client_secret' => env('GOOGLE_CLIENT_SECRET', ''),
        'redirect'      => env('GOOGLE_URL', 'https://shaup/login/google/callback'),
    ],

    'linkedin' => [
        'client_id'     => env('LINKEDIN_CLIENT_ID', '865u0ylzwtzaml'),
        'client_secret' => env('LINKEDIN_CLIENT_SECRET', 'Dzs63Vr5cCw6geTB'),
        'redirect'      => env('LINKEDIN_CALLBACK_URL', 'https://shaup/login/linkedin/callback'),
    ],
